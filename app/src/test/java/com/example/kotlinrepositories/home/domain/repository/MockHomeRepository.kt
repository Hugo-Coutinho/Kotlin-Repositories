...
object MockHomeRepository {
    ...
    fun getMockKotlinRepositories(): Observable<List<HomeRepositoryEntity>> {
    ...
    private fun mockEntity(): HomeRepositoryEntity {
        ...
        return HomeRepositoryEntity("architecture-samples",false, owner.login, "A collection of samples to discuss and showcase different architectural tools and patterns for Android apps.","https://github.com/google/flexbox-layout","" , 36642,10175)
    }
}