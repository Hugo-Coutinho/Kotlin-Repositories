...
object MockHomeRepository {
    ...
    private fun mockEntity(): HomeRepositoryEntity {
        ...
        return HomeRepositoryEntity("architecture-samples", owner.login, "A collection of samples to discuss and showcase different architectural tools and patterns for Android apps.","https://github.com/google/flexbox-webview_repository_page","" , 36642,10175)
    }
}